...
module.exports = {
	VERSION: 'v4.4.1', 
    SESSION_ID: process.env.SESSION_ID || '01_18_H_E_R_M_I_T_QC_3NHO',
    ...
    BOT_NAME: process.env.BOT_NAME || 'ꫀ᥆ઽꫂꫀꪚꪱ૮',
    ...
    BOT_INFO: process.env.BOT_INFO || 'ꫀ᥆ઽꫂꫀꪚꪱ૮;promdev;2349067654525;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'ʜᴇʀᴍɪᴛ;ᴀᴅɪᴛʜyᴀɴ;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'ꫀ᥆ઽꫂꫀꪚꪱ૮;ꫀ᥆ઽꫂꫀꪚꪱ૮' : process.env.STICKER_DATA,
